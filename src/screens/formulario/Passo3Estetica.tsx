...
export default function Passo3Estetica({ dados, atualizar, onNext, onBack, passo, totalPassos }: PassoProps) {
  ...
  function setItem(chave: keyof ChecklistEstetica, valor: ItemChecklist) {
    atualizar({ checklist_estetica: { ...checklist, [chave]: valor } });
  }
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.instrucao}>
          Avalie cada item visualmente. Toque em{' '}
